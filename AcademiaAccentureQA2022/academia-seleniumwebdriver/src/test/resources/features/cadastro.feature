...
Feature: Cadastro em E-commerce
	...
	Scenario Outline: Acessar site 
	  ...
	  And preencher o  "<email>"  no campo de E-mail
		...
		Examples:
		|email								      |FirstName |LastName |passwd    |comboboxDay |comboboxMonths |comboboxYears |txtCompany |txtAddress          |txtAddressTwo |txtCity   |State              |txtPostalCode |txtAdditionalInformation                                                              |txtHomePhone      |txtPhoneMobile      |txtAddressAlias   |
		|camilalnmoura@gmail.com |Camila    |Moura    |Teste@123 |9           |2              |1990          |Accenture  |155 6th Ave, U.S.A  |10th Floor    |New York  |32                 |00000         |Important to carry document with photo for registration and release at the concierge. |+1 (212) 380-7700 |+1 (212) 98888-7845 |155 6th Ave - NY  |